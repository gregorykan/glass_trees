# module Api
  class Api::GroupsController < ApiController
    ...
    # GET /groups
    def index
      @group = Group.where(id: current_api_user.group_id).first || nil
    ...
    def create
      ...
      @group = Group.create_and_update_creator(group_params, current_api_user)
      if @group.errors.empty?
        current_api_user.group = @group
